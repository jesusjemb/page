...
/*-----------------------------------------------------*/
  ...
  var textSet = [
    { text: "HANNCITAA", sphereRadius: 100, sphereSpace: 80, unitTime: 50, time: 1000 },
    {
      text: "CORROMPEDORA",
      sphereRadius: 100,
      sphereSpace: 80,
  ...
  var start = function () {
    ...
    tiempoAnimacion += 1000 / 60;  // Incrementar el tiempo transcurrido

    if (tiempoAnimacion >= 74500) {
      // Detener la animación después de 15 segundos (ajustado de 35 segundos)
